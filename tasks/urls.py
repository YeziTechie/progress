...
urlpatterns = [
    path('<int:pk>/classic/create/', ClassicCreateView.as_view(), name='classic_create'),
    ...
    path('<int:pk>/count/create/', CountCreateView.as_view(), name='count_create'),
    ...
    path('<int:pk>/time/create/', TimeCreateView.as_view(), name='time_create'),
    ...
    path('<int:pk>/deadline/create/', DeadlineCreateView.as_view(), name='deadline_create'),
