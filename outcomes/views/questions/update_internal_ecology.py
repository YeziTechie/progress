...
from outcomes.models.ecology import InternalEcology
from outcomes.forms.questions import InternalEcologyUpdateForm


class InternalEcologyUpdateView(LoginRequiredMixin, UpdateView):
