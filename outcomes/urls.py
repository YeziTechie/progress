...
urlpatterns = [
    ...
    path('<int:pk>/questions/external-ecology/update/', ExternalEcologyUpdateView.as_view(), name=f'external_{eu}'),
    path('<int:pk>/questions/internal-ecology/update/', InternalEcologyUpdateView.as_view(), name=f'internal_{eu}'),
